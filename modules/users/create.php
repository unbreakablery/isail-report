<?php
    ...
    $iSAIL_UI->title = $common->getPrefixProjectName() . ' ' . 'Create User';
...
<div class="content">
    <div class="row remove-margin-l remove-margin-r">
        ...
        <div class="alert alert-info alert-dismissable">
            ...
            <p><i class='fa fa-info-circle'></i> Click <a class="alert-link" href="import_csv.php"><em>here</em></a> to import users from csv file.</p>
        </div>
        <!-- END Info Alert -->
    </div>
    ...
    <div class="block">
        ...
        <div class="block-content">
            <form class="form-horizontal push-10-t" id="userForm" method="post">
                <input type="hidden" name="action_name" value="create_user" />
                
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="text" name="userid" placeholder="UNIX_ID" value="" required />
                            <label class="text-uppercase">UNIX_ID <span class="text-danger">*</span> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" data-original-title="Alpanumeric without space"></i></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="email" name="email" placeholder="example@domain.com" value="" />
                            <label class="text-uppercase">Email</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="text" name="password" placeholder="Password" value="" required />
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="number" name="role" placeholder="Role" value="" min="1" max="4" required />
                            <label class="text-uppercase">Role <span class="text-danger">*</span></label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="text" name="org_ID" placeholder="Organization" value="" />
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="text" name="franchise" placeholder="Franchise" value="" />
                            <label class="text-uppercase">Franchise</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="text" name="product" placeholder="Product" value="" />
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="text" name="indication" placeholder="Indication" value="" />
                            <label class="text-uppercase">Indication</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="text" name="gkn" placeholder="Game Key Number : MaxLength is 24" value="" maxlength="24" />
                    ...
                    <div class="col-sm-6">
                        <div class="form-material form-material-primary">
                            <select class="form-control" name="who_dm" size="1">
                                ...
                                <option value="<?php echo $dm['userid']; ?>"><?php echo $dm['username']; ?></option>
                                <?php } ?>
                            </select>
...
<div class="modal fade" id="confirm-create-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-popout">
        <div class="modal-content">
                ...
                <div class="block-content">
                    <div class="text-center text-default">
                        <p>
                            ...
                            Would you create new user really?
                        </p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button class="btn btn-sm btn-primary" type="button" data-dismiss="modal" id="create-yes-button"><i class="fa fa-check"></i> Yes</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#userForm").submit(function(e) {
            ...
            $("#confirm-create-modal").modal({backdrop: 'static'});
        });
        ...
        $("button#create-yes-button").click(function() {
