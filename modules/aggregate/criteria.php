<?php 
    ...
    $iSAIL_UI->title = $common->getPrefixProjectName() . ' ' . 'Aggregate Report - Criteria';
?>
...
<script>
    $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success:    function( data ) {
                                    if (!data.status) {
                                        ...
                                        setSpecificTimeFromLocalStorage('aggregate_form');
                                    }
                                }
                });
            } else {
        ...
        // save form
        // try to load values
        var session = window.localStorage.getItem('aggregate_form');
        ...
        $('#reportForm').submit(function () {
            ...
            if ($('#criteria-remember').is(':checked')) {
                window.localStorage.setItem('aggregate_form', JSON.stringify($(this).serializeArray()));
            } else {
