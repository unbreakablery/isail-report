/*
 *  Document   : isail_learner_performance_charts.js
 *  Author     : Anna
...
var BaseCompCharts = (function() {
  ...
  var initChartsChartJS = function() {
    ...
    $chartPolar = new Chart($chartPolarCon).PolarArea(
      $chartPolarPieDonutData,
      $globalOptions
    );
    $chartPie = new Chart($chartPieCon).Pie(
      $chartPolarPieDonutData,
      $globalOptions
    );
    $chartDonut = new Chart($chartDonutCon).Doughnut(
      $chartPolarPieDonutData,
      $globalOptions
    );
  };
  ...
  var initChartsSparkline = function() {
    ...
    for (var i = 0; i < 10; i += 1) {
      var value = jQuery('.js-slc-bar' + i).text();
      jQuery('.js-slc-bar' + i).replaceWith(
      ...
      var chart = new Chart(ctx, {
        ...
        data: {
          datasets: [
            { backgroundColor: getBarColor(value), data: [value] },
            { backgroundColor: '#ededed', data: [100 - value] }
          ]
        },
        options: {
          title: {
      ...
      //if(i > 0) {
        //chart.canvas.style.width = '33.33%';
        //chart.canvas.style.width = '250px';
